    ...
    def extract(self, page_text: list[str]) -> BedrockClaimExtraction:
        ...
        request = {
            ...
            "system": (
                ...
                "\n"
                "VALUE vs EXCERPT — these are two different things and must not be "
                "conflated. `value` is the parsed datum (charged_days is a bare "
                "integer like 7, never '7 days'; rates and totals keep their "
                "currency formatting like '$350.00'; dates stay as written). "
                "`text_excerpt` is the quoted proof located in the source. The "
                "excerpt may contain extra words the value does not.\n"
                "\n"
                ...
                "  daily_rate    value '$350.00'       excerpt '$350.00'\n"
                "                  (excerpt NOT '$350.00 / day' — the / is a cell "
                "separator)\n"
                "  charged_days  value 7               excerpt '7 days'\n"
                "                  (value is the integer 7, NOT the string "
                "'7 days')\n"
                "  period_start  value 'June 8, 2026'  excerpt 'June 8, 2026'\n"
                "  period_end    value 'June 14, 2026' excerpt 'June 14, 2026'\n"
                "                  (each date quoted alone, never spanning the row)\n"
                "  source line: 'TOTAL AMOUNT DUE $2,450.00'\n"
                "  total         value '$2,450.00'     excerpt '$2,450.00'\n"
            ),
